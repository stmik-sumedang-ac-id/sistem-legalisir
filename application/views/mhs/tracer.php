		<div class="container">      
			<!-- <h3>Formulir tracer study</h3> -->
			<h3>Kuesioner Penelusuran Alumni STMIK Sumedang</h3>
			
			<div class="row">
				<form class="form-horizontal" action="<?php echo base_url($this->uri->segment(1).'/'.$this->router->fetch_class())?>" method="post">
					<div class="col-md-12">
					<!-- content starts -->					
						...
						<div class="form-group">
							...
							<div class="col-md-3"><?php echo form_error('elemen['.$element->id_form.']'); ?></div>
						</div>
						<?php $i++;endforeach;?>
						 <div class="form-actions">
						 	<div class="row">										
								<div class="col-md-3"><a href="<?php echo base_url($this->uri->segment(1).'/dashboard')?>" class="btn btn-info pull-right"><i class="glyphicon glyphicon-chevron-left"></i> Dashboard</a> </div>
								<div class="col-md-offset-2 col-md-3"><button type="submit" class="btn btn-primary pull-right">Submit formulir tracer study</button></div>
							</div>
						  </div>
						<?php endif;?>					
					<!-- content ends -->
