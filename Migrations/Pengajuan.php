<div class="container">    
      ...
      <div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-2"><select name="t" class="form-control"><option>2019</option></select></div>
		...
		<h4 class="tcenter">Laporan Pengajuan Aplikasi Legalisir Tahun 2019 Seluruh Prodi</h4>
		<div class="row">
			<div class="col-sm-6">
